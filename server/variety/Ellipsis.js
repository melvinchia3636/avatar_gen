module.exports = function Ellipsis({
  ...
  return `<svg width="${size || '128'}" height="${size || '128'}" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">${['M64 0C28.6538 0 0 28.6538 0 64H128C128 28.6538 99.3462 0 64 0Z',
    ...
    'M64 101C84.4345 101 101 84.4345 101 64L27 64C27 84.4345 43.5655 101 64 101Z'].map((e, i) => `<path d="${e}" fill="${`rgb(${finalPalette[pixels[i][0]].join(',')})`}" />`).join('')}</svg>`;
};
