  ...
  return (
    <div className="w-full h-screen flex flex-col px-4 overflow-x-visible">
      <div className="App w-full h-full overflow-hidden flex flex-col gap-6 items-center justify-center">
        ...
        <input type="text" onChange={(e) => setSeed(e.target.value)} value={seed} placeholder="Enter your username" className="transition-all focus:ring-4 focus:outline-none rounded-full shadow-md w-full sm:w-96 text-xl tracking-wider text-center py-4 bg-gray-200" />
